...
if not args.input:
    ...
    for i in range(p.get_device_count()):
        print("Device number {}: {}".format(i, p.get_device_info_by_index(i).get('name')))
...
buffer_size = 4096 # for undistorted audio. look up
...
# setup onset detector (mess with these settings)
